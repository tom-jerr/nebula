...
class MockData {
 public:
   ...
   * Mock schema
   */
  static std::shared_ptr<meta::NebulaSchemaProvider> mockPlayerTagSchema(ObjectPool* pool = nullptr,
                                                                         SchemaVer ver = 0,
                                                                         bool hasProp = true);
  ...
  static std::shared_ptr<meta::NebulaSchemaProvider> mockServeEdgeSchema(ObjectPool* pool = nullptr,
                                                                         SchemaVer ver = 0,
                                                                         bool hasProp = true);
  ...
  static std::unordered_map<PartitionID, std::vector<EdgeData>> mockEdgesofPart(int32_t parts = 6);
  ...
  static nebula::storage::cpp2::DeleteEdgesRequest mockDeleteEdgesReq(int32_t parts = 6);
