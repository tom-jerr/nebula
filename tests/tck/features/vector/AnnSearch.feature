Feature: Ann Search Tests
  ...
  Scenario: Test Ann Search
    ...
    Then the result should be, in any order:
      | name           | labels            | embedding        | distance    |
      | "Kevin Durant" | ["player_vector"] | [0.88,0.90,0.85] | 0.06164414  |
      | "Pat Riley"    | ["coach_vector"]  | [0.90,0.86,0.92] | 0.041231056 |
      | "LeBron James" | ["player_vector"] | [0.91,0.82,0.87] | 0.033166248 |
    # Drop the ann index
    When executing query:
      """
